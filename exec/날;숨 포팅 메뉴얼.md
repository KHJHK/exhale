...
spring.datasource.url=jdbc:mysql:DB정보삭제?serverTimezone=UTC&useUniCode=yes&characterEncoding=UTF-8
spring.datasource.hikari.username=DB유저이름삭제
spring.datasource.hikari.password=DB패스워드삭제
...
spring.datasource.url=jdbc:mysql:DB정보삭제?serverTimezone=UTC&useUniCode=yes&characterEncoding=UTF-8
spring.datasource.hikari.username=DB유저이름삭제
spring.datasource.hikari.password=DB비밀번호삭제
